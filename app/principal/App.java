...
import app.gerador.GeradorPropriedadesBridge;
import app.gerador.GeradorXMLBridge;
...
public class App {
    public static void main(String[] args) {
        ...
        final GeradorXMLBridge meuGeradorXMLCompactado = new GeradorXMLBridge();
        ...
        GeradorPropriedadesBridge meuGeradorPropriedadesCifrado = new GeradorPropriedadesBridge();
        int delay=1;
